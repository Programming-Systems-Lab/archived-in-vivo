...
void _Build_Show(int HuaSe[], float DianShu[], char ShuZi[]);
void preBuild_Show(int HuaSe[], float DianShu[], char ShuZi[]);
void postBuild_Show(int HuaSe[], float DianShu[], char ShuZi[]);
...
int main(void)
{
   int  flag, n;
   int HuaSe[4]={3,4,5,6};
   char ShuZi[13]={'A','K','Q','J','0','9','8','7','6','5','4','3','2'};
   float DianShu[13]={1,0.5,0.5,0.5,10,9,8,7,6,5,4,3,2}; 
   
   Build_Show(HuaSe, DianShu, ShuZi);
   do{
      Wash_Card();
...
void preBuild_Show(int HuaSe[], float DianShu[], char ShuZi[])
{
        printf("preBuild_Show\n");
}

void postBuild_Show(int HuaSe[], float DianShu[], char ShuZi[])
{
        printf("postBuild_Show\n");
}


void Build_Show(int HuaSe[], float DianShu[], char ShuZi[])
{
if (should_run_test("Build_Show") == 0) 
				{ 
					if (fork() == 0) 
					{ 
						preBuild_Show(HuaSe,DianShu,ShuZi); 
						exit(0); 
					} 
					else 
					{ 
 ...
 _Build_Show(HuaSe,DianShu,ShuZi);
	
				if (should_run_test("Build_Show") == 0) 
				{ 
					if (fork() == 0) 
					{ 
						postBuild_Show(HuaSe,DianShu,ShuZi); 
						exit(0); 
					} 
					else 
					{ 
