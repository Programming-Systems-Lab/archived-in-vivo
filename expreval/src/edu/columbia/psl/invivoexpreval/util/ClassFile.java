...
import edu.columbia.psl.invivoexpreval.Descriptor;
import edu.columbia.psl.invivoexpreval.InVivoRuntimeException;
...
public class ClassFile {
     ...
     * @param accessFlags as defined by {@link edu.columbia.psl.invivoexpreval.Mod}
...
//        }
    ...
    public short addConstantClassInfo(String typeFD) {
        ...
        {
            throw new InVivoRuntimeException("\"" + Descriptor.toString(typeFD) + "\" is neither a class nor an array");
        }
    ...
    private short addConstantSIFLDInfo(Object cv) {
        ...
        {
            throw new InVivoRuntimeException("Unexpected constant value type \"" + cv.getClass().getName() + "\"");
        }
    }
    ...
    private short addToConstantPool(ConstantPoolInfo cpi) {
        ...
        if (res > 0xFFFF) {
            throw new InVivoRuntimeException("Constant pool has grown past JVM limit of 0xFFFF");
        }
...
//System.out.println("tag=" + tag);
    ...
    public static class ConstantUtf8Info extends ConstantPoolInfo {
        ...
        public ConstantUtf8Info(String s) {
            if (s == null) throw new InVivoRuntimeException();
            this.s = s;
        }
