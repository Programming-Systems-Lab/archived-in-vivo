...
import edu.columbia.psl.commons.compiler.Cookable;
import edu.columbia.psl.commons.compiler.IExpressionEvaluator;
import edu.columbia.psl.commons.compiler.IScriptEvaluator;
...
public class ScriptEvaluator extends ClassBodyEvaluator implements IScriptEvaluator {
    ...
    public final void cook(
        ...
        try {
            ...
            throw new InVivoRuntimeException("SNO: IOException despite StringReader");
        }
    }
    ...
    public Object createFastEvaluator(
        ...
        try {
            ...
            throw new InVivoRuntimeException("IOException despite StringReader");
        }
    }

    /**
     * Notice: This method is not declared in {@link IScriptEvaluator}, and is hence only available in <i>this</i>
     * implementation of <code>edu.columbia.psl.commons.compiler</code>. To be independent from this particular
    ...
    public Object createFastEvaluator(
        ...
        if (!interfaceToImplement.isInterface()) {
            throw new InVivoRuntimeException("\"" + interfaceToImplement + "\" is not an interface");
        }
        ...
        try {
            ...
            throw new InVivoRuntimeException(e.toString());
    ...
    public Object evaluate(int idx, Object[] arguments) throws InvocationTargetException {
        ...
        try {
            ...
            throw new InVivoRuntimeException(ex.toString());
        }
    }
