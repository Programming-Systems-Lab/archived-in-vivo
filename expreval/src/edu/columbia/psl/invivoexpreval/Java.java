...
import edu.columbia.psl.invivoexpreval.CodeContext.Offset;
import edu.columbia.psl.invivoexpreval.util.Traverser;
import edu.columbia.psl.invivoexpreval.util.iterator.ReverseListIterator;
...
public final class Java {
    ...
    public static final class CompilationUnit implements Scope {
        ...
        public Scope getEnclosingScope() {
            throw new InVivoRuntimeException("A compilation unit has no enclosing scope");
        }

        public void setPackageDeclaration(PackageDeclaration packageDeclaration) {
            if (this.optionalPackageDeclaration != null) {
                throw new InVivoRuntimeException("Re-setting package declaration");
            }
    ...
    public abstract static class ClassDeclaration extends AbstractTypeDeclaration {
        ...
        public void defineSyntheticField(IClass.IField iField) throws CompileException {
            if (!(this instanceof InnerClassDeclaration)) throw new InVivoRuntimeException();

            IClass.IField if2 = (IClass.IField) this.syntheticFields.get(iField.getName());
            if (if2 != null) {
                if (iField.getType() != if2.getType()) throw new InVivoRuntimeException();
                return;
            }
     ...
     * {@link edu.columbia.psl.invivoexpreval.Java.Scope} of the given
     * {@link edu.columbia.psl.invivoexpreval.Java.TypeDeclaration}.
     */
    ...
    private static void setEnclosingBlockStatement(
        ...
        {
            throw new InVivoRuntimeException("Unexpected array or initializer class " + aiorv.getClass().getName());
        }
    }
    ...
    public abstract static class Type extends Atom {
         ...
         * {@link edu.columbia.psl.invivoexpreval.Java.Type} objects.
         */
    ...
    public static final class BasicType extends Type {
        ...
        public String toString() {
            ...
            case BasicType.BOOLEAN:
                return "boolean";
            default:
                throw new InVivoRuntimeException("Invalid index " + this.index);
            }
        }
    ...
    public abstract static class Rvalue extends Atom implements ArrayInitializerOrRvalue {
         ...
         * {@link edu.columbia.psl.invivoexpreval.Java.Rvalue} objects.
         */
