...
import edu.columbia.psl.invivoexpreval.Visitor.TypeVisitor;
...
public class SimpleCompiler extends Cookable implements ISimpleCompiler {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length >= 1 && args[0].equals("-help")) {
            ...
            System.out.println("    edu.columbia.psl.invivoexpreval.SimpleCompiler <source-file> <class-name> { <argument> }");
            ...
            private Type getDelegate() {
                if (this.delegate == null) {
                    ...
                    try {
                        ...
                        throw new InVivoRuntimeException("Loading IClass \"" + clazz.getName() + "\": " + ex);
                    }
                    if (iClass == null) {
