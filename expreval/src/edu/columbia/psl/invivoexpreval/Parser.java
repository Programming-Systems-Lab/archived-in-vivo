...
import edu.columbia.psl.invivoexpreval.Java.AlternateConstructorInvocation;
import edu.columbia.psl.invivoexpreval.Java.AmbiguousName;
import edu.columbia.psl.invivoexpreval.Java.AnonymousClassDeclaration;
import edu.columbia.psl.invivoexpreval.Java.ArrayAccessExpression;
import edu.columbia.psl.invivoexpreval.Java.ArrayInitializer;
import edu.columbia.psl.invivoexpreval.Java.ArrayInitializerOrRvalue;
import edu.columbia.psl.invivoexpreval.Java.ArrayType;
import edu.columbia.psl.invivoexpreval.Java.Assignment;
import edu.columbia.psl.invivoexpreval.Java.Atom;
import edu.columbia.psl.invivoexpreval.Java.BasicType;
import edu.columbia.psl.invivoexpreval.Java.BinaryOperation;
import edu.columbia.psl.invivoexpreval.Java.Block;
import edu.columbia.psl.invivoexpreval.Java.BlockStatement;
import edu.columbia.psl.invivoexpreval.Java.BooleanLiteral;
import edu.columbia.psl.invivoexpreval.Java.BreakStatement;
import edu.columbia.psl.invivoexpreval.Java.Cast;
import edu.columbia.psl.invivoexpreval.Java.CatchClause;
import edu.columbia.psl.invivoexpreval.Java.CharacterLiteral;
import edu.columbia.psl.invivoexpreval.Java.ClassDeclaration;
import edu.columbia.psl.invivoexpreval.Java.ClassLiteral;
import edu.columbia.psl.invivoexpreval.Java.CompilationUnit;
import edu.columbia.psl.invivoexpreval.Java.ConditionalExpression;
import edu.columbia.psl.invivoexpreval.Java.ConstructorDeclarator;
import edu.columbia.psl.invivoexpreval.Java.ConstructorInvocation;
import edu.columbia.psl.invivoexpreval.Java.ContinueStatement;
import edu.columbia.psl.invivoexpreval.Java.Crement;
import edu.columbia.psl.invivoexpreval.Java.DoStatement;
import edu.columbia.psl.invivoexpreval.Java.EmptyStatement;
import edu.columbia.psl.invivoexpreval.Java.ExpressionStatement;
import edu.columbia.psl.invivoexpreval.Java.FieldAccessExpression;
import edu.columbia.psl.invivoexpreval.Java.FieldDeclaration;
import edu.columbia.psl.invivoexpreval.Java.FloatingPointLiteral;
import edu.columbia.psl.invivoexpreval.Java.ForStatement;
import edu.columbia.psl.invivoexpreval.Java.FunctionDeclarator;
import edu.columbia.psl.invivoexpreval.Java.IfStatement;
import edu.columbia.psl.invivoexpreval.Java.Initializer;
import edu.columbia.psl.invivoexpreval.Java.Instanceof;
import edu.columbia.psl.invivoexpreval.Java.IntegerLiteral;
import edu.columbia.psl.invivoexpreval.Java.InterfaceDeclaration;
import edu.columbia.psl.invivoexpreval.Java.LabeledStatement;
import edu.columbia.psl.invivoexpreval.Java.LocalClassDeclaration;
import edu.columbia.psl.invivoexpreval.Java.LocalClassDeclarationStatement;
import edu.columbia.psl.invivoexpreval.Java.LocalVariableDeclarationStatement;
import edu.columbia.psl.invivoexpreval.Java.Lvalue;
import edu.columbia.psl.invivoexpreval.Java.MemberClassDeclaration;
import edu.columbia.psl.invivoexpreval.Java.MemberInterfaceDeclaration;
import edu.columbia.psl.invivoexpreval.Java.MemberTypeDeclaration;
import edu.columbia.psl.invivoexpreval.Java.MethodDeclarator;
import edu.columbia.psl.invivoexpreval.Java.MethodInvocation;
import edu.columbia.psl.invivoexpreval.Java.NamedClassDeclaration;
import edu.columbia.psl.invivoexpreval.Java.NewAnonymousClassInstance;
import edu.columbia.psl.invivoexpreval.Java.NewArray;
import edu.columbia.psl.invivoexpreval.Java.NewClassInstance;
import edu.columbia.psl.invivoexpreval.Java.NewInitializedArray;
import edu.columbia.psl.invivoexpreval.Java.NullLiteral;
import edu.columbia.psl.invivoexpreval.Java.PackageDeclaration;
import edu.columbia.psl.invivoexpreval.Java.PackageMemberClassDeclaration;
import edu.columbia.psl.invivoexpreval.Java.PackageMemberInterfaceDeclaration;
import edu.columbia.psl.invivoexpreval.Java.PackageMemberTypeDeclaration;
import edu.columbia.psl.invivoexpreval.Java.ParenthesizedExpression;
import edu.columbia.psl.invivoexpreval.Java.QualifiedThisReference;
import edu.columbia.psl.invivoexpreval.Java.ReferenceType;
import edu.columbia.psl.invivoexpreval.Java.ReturnStatement;
import edu.columbia.psl.invivoexpreval.Java.Rvalue;
import edu.columbia.psl.invivoexpreval.Java.RvalueMemberType;
import edu.columbia.psl.invivoexpreval.Java.Statement;
import edu.columbia.psl.invivoexpreval.Java.StringLiteral;
import edu.columbia.psl.invivoexpreval.Java.SuperConstructorInvocation;
import edu.columbia.psl.invivoexpreval.Java.SuperclassFieldAccessExpression;
import edu.columbia.psl.invivoexpreval.Java.SuperclassMethodInvocation;
import edu.columbia.psl.invivoexpreval.Java.SwitchStatement;
import edu.columbia.psl.invivoexpreval.Java.SynchronizedStatement;
import edu.columbia.psl.invivoexpreval.Java.ThisReference;
import edu.columbia.psl.invivoexpreval.Java.ThrowStatement;
import edu.columbia.psl.invivoexpreval.Java.TryStatement;
import edu.columbia.psl.invivoexpreval.Java.Type;
import edu.columbia.psl.invivoexpreval.Java.UnaryOperation;
import edu.columbia.psl.invivoexpreval.Java.VariableDeclarator;
import edu.columbia.psl.invivoexpreval.Java.WhileStatement;
import edu.columbia.psl.invivoexpreval.Java.CompilationUnit.ImportDeclaration;
import edu.columbia.psl.invivoexpreval.Scanner.Token;
...
public class Parser {
    ...
    public NamedClassDeclaration parseClassDeclarationRest(
        ...
        {
            throw new InVivoRuntimeException("SNO: Class declaration in unexpected context " + context);
        }
    ...
    public InterfaceDeclaration parseInterfaceDeclarationRest(
        ...
        {
            throw new InVivoRuntimeException("SNO: Interface declaration in unexpected context " + context);
        }
