...
public final class Descriptor {
    ...
    public static short size(String d) {
        ...
        throw new InVivoRuntimeException("No size defined for type \"" + Descriptor.toString(d) + "\"");
    }
    ...
    public static String toString(String d) {
        ...
        if (d.charAt(0) == '(') {
            ...
            if (idx >= d.length()) throw new InVivoRuntimeException("Invalid descriptor \"" + d + "\"");
            sb.append(") => ");
            ++idx;
        }
    ...
    private static int toString(String d, int idx, StringBuffer sb) {
        ...
        case 'L':
            {
                ...
                if (idx2 == -1) throw new InVivoRuntimeException("Invalid descriptor \"" + d + "\"");
        ...
        case 'Z':
            ...
            break;
        default:
            throw new InVivoRuntimeException("Invalid descriptor \"" + d + "\"");
        }
    ...
    public static String toClassName(String d) {
        ...
        throw new InVivoRuntimeException("(Invalid field descriptor \"" + d + "\")");
    }
    ...
    public static String getPackageName(String d) {
        if (d.charAt(0) != 'L') {
            throw new InVivoRuntimeException("Attempt to get package name of non-class descriptor \"" + d + "\"");
        }
