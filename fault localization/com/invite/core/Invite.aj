...
/********   INSTRUMENTATION FOR CLASS IntFields   ********/
	...
	private static int IntFields.nextId = 0; // set on object creation, is index in vector below
	...
	after( IntFields newValue ) : IntFieldsCall( newValue ) && notInvite() && notTestMethod()
	{
